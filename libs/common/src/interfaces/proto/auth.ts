...
export interface UserServiceClient {
  ...
  updateUser(request: UpdateDto<User>): Observable<User>;
...
export interface UserServiceController {
  ...
  updateUser(request: UpdateDto<User>): Promise<User> | Observable<User> | User;
...
export interface AuthServiceClient {
  validateUser(request: LoginUserDto): Observable<User>;

  login(request: User): Observable<Tokens>;

  register(request: RegisterUserDto): Observable<User>;

  logout(request: User): Observable<User>;

  verifyToken(request: RefreshTokenQueryDto): Observable<any>;

  refreshUserToken(request: User): Observable<Tokens>;

  findRefreshToken(request: RefreshTokenQueryDto): Observable<RefreshToken>;

  saveUserRefreshToken(request: CreateRefreshTokenDto): Observable<RefreshToken>;

  removeRefreshToken(request: RefreshTokenQueryDto): Observable<RefreshToken>;

  removeManyRefreshToken(request: RefreshTokenQueryDto): Observable<RefreshTokens>;
}
...
export interface AuthServiceController {
  ...
  login(request: User): Promise<Tokens> | Observable<Tokens> | Tokens;

  register(request: RegisterUserDto): Promise<User> | Observable<User> | User;

  logout(request: User): Promise<User> | Observable<User> | User;

  verifyToken(request: RefreshTokenQueryDto): Promise<any> | Observable<any> | any;

  refreshUserToken(request: User): Promise<Tokens> | Observable<Tokens> | Tokens;

  findRefreshToken(request: RefreshTokenQueryDto): Promise<RefreshToken> | Observable<RefreshToken> | RefreshToken;

  saveUserRefreshToken(request: CreateRefreshTokenDto): Promise<RefreshToken> | Observable<RefreshToken> | RefreshToken;

  removeRefreshToken(request: RefreshTokenQueryDto): Promise<RefreshToken> | Observable<RefreshToken> | RefreshToken;

  removeManyRefreshToken(request: RefreshTokenQueryDto): Promise<RefreshTokens> | Observable<RefreshTokens> | RefreshTokens;
}
